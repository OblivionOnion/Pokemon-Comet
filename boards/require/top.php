...
$qcheck = mysql_query("SELECT * FROM `users` WHERE `id`='".$_SESSION['id']."'");
$bancheck = mysql_fetch_array($qcheck);
if($bancheck['rank']=="Banned") {
echo "";
die();
}
else {
...
<link rel="shortcut icon" href="http://pokemoncomet.co.cc/images/sprites/etc/favo_icon.png" />
<script src='require/jquery.js' language='javascript' type='text/javascript'></script>
<script src='require/main.js' language='javascript' type='text/javascript'></script>
</head>
<body>
<script src='require/tooltip.js' language='javascript' type='text/javascript'></script>
<div id='centerlayout'>
...
<?php
if($bancheck['rank']=="Administrator" || $r1['rank']=="Moderator") {
...
<h1>Promo</h1>
<a href='../promo.php'><img src="http://pcomet.comeze.com/images/sprites/<?php echo $result1['picture']; ?>.png" title='Click to Obtain Promo' alt='Promo' /></a><br>
<h1>Referrals</h1>
